...
import pl.dmcs.arogacki.message.request.LoginForm;
import pl.dmcs.arogacki.message.request.SignUpForm;
import pl.dmcs.arogacki.message.response.JwtResponse;
import pl.dmcs.arogacki.message.response.ResponseMessage;
...
import pl.dmcs.arogacki.security.jwt.JwtProvider;
...
public class AuthRESTController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest){
        ...
        User user = new User(signUpRequest.getUsername(),
                ...
                signUpRequest.getPublicProfile());
            ...
            switch (role) {
                ...
                case "band":
                    Role bandRole = roleRepository.findByName(RoleName.ROLE_BAND)
                            .orElseThrow(() -> new RuntimeException("Fail -> Cause: Band Role not found."));
                    roles.add(bandRole);
                    break;
            }
        });
